...
function searchMeal(e){
    ...
    if(term.trim()){
        ...
        .then((res) => res.json())
        .then((data) => {
            // console.log(`<h2>Search Result for: ${term}</h2>`);
            resultHeading.innerHTML = `<h2>Search Result for: ${term}</h2>`;
            ...
            if(data.meals === null){
                ...
                // resultHeading.innerHTML = `<h2>Search Result for: ${term}</h2>`;
                // resultHeading.innerHTML = "hii";
                console.log( resultHeading.innerHTML);
                // document.getElementsByClassName("result-heading").innerHTML = `<h2>Search Result for: ${term}</h2>`;;
        ...
        // To convert the data underJSON file
